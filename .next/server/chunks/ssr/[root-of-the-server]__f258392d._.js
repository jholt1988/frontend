...
"[project]/src/app/features/PaymentHistory.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PaymentHistory() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user?.role === 'tenant') {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$apiService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMyPayments"])().then((data)=>setPayments(data)).catch((err)=>console.error('Failed to load payment history:', err)).finally(()=>setLoading(false));
        }
    }, [
        user
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f258392d._.js.map