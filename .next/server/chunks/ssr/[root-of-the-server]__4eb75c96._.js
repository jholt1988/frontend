...
const loginUser = async (userData)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$axiosInstance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', userData);
    return res.data;
};
const registerUser = async (userData)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$axiosInstance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', userData);
    return res.data;
};
}}),
...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const { token } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerUser"])(formData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4eb75c96._.js.map