...
"[project]/src/app/features/PaymentList.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PaymentsList() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentsList.useEffect": ()=>{
            if (user?.role === 'staff' || user?.role === 'admin') {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$apiService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllPayments"])().then({
                    "PaymentsList.useEffect": (data)=>setPayments(data)
                }["PaymentsList.useEffect"]).catch({
                    "PaymentsList.useEffect": (err)=>console.error('Failed to load payments:', err)
                }["PaymentsList.useEffect"]).finally({
                    "PaymentsList.useEffect": ()=>setLoading(false)
                }["PaymentsList.useEffect"]);
            }
        }
    }["PaymentsList.useEffect"], [
...
_s(PaymentsList, "HxKhBEqgaH1QeJ1vbd+9OCax+JU=");
_c = PaymentsList;
var _c;
__turbopack_context__.k.register(_c, "PaymentsList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_d120bd66._.js.map